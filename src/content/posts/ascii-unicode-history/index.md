...
pinned: false
description: 字符编码的演化史，从1960年代一直延续到今天，见证了计算机从美国实验室走向全世界的全过程。本文将带你回顾从ASCII到Unicode的历史，了解字符编码如何从单字节扩展到多字节，最终实现全球统一。
tags: [Markdown, ascii, unicode, computer history]
category: 计算机历史
