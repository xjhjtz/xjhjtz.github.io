...
export const profileConfig: ProfileConfig = {
  avatar:
    "https://cdn.jsdmirror.com/gh/xjhjtz/xjhjtz.github.io/src/assets/images/avatar.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
  name: "xjhjtzac",
  bio: "你好，世界！",
  typewriter: {
...
export const commentConfig: CommentConfig = {
  ...
  giscus: {
    repo: "xjhjtz/xjhjtz.github.io",
    repoId: "R_kgDORObyEA",
    category: "Announcements",
    categoryId: "DIC_kwDORObyEM4DASfZ",
    mapping: "pathname",
    strict: "0",
    reactionsEnabled: "1",
    emitMetadata: "0",
